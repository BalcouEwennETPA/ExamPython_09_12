...
elif(propMot [2] == mot[1]or propMot [2] == mot[2]or propMot [2] == mot[3]or propMot [2] == mot[4]or propMot [2] == mot[5]):
    print (Back.GREEN + propMot[2],end="")
else:
    print (Back.BLUE + propMot[2],end="")

if (propMot [3] == mot [3]) :
    print (Back.RED + propMot[3],end="")
elif(propMot [3] == mot[1]or propMot [3] == mot[2]or propMot [3] == mot[3]or propMot [3] == mot[4]or propMot [3] == mot[5]):
    print (Back.GREEN + propMot[3],end="")
else:
    print (Back.BLUE + propMot[3],end="")

if (propMot [4] == mot [0]) :
    print (Back.RED + propMot[4],end="")
elif(propMot [4] == mot[1]or propMot [4] == mot[2]or propMot [4] == mot[3]or propMot [4] == mot[4]or propMot [4] == mot[5]):
    print (Back.GREEN + propMot[4],end="")
else:
    print (Back.BLUE + propMot[4],end="")

if (propMot [5] == mot [1]) :
    print (Back.RED + propMot[5],end="")
elif(propMot [5] == mot[1]or propMot [5] == mot[2]or propMot [5] == mot[3]or propMot [5] == mot[4]or propMot [5] == mot[5]):
    print (Back.GREEN + propMot[5],end="")
else:
